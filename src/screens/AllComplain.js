...
import AllComplainListItem from '../components/AllComplainListItem';
...
const AllComplain = () => {
  ...
  const searchByDate = () => {
    ...
    console.log("AllComplain FromDate: " + moment(fromDate).format("DD-MMM-YYYY") + " ToDate: " + moment(toDate).format("DD-MMM-YYYY"));
