...
import AllTrackerListItem from '../components/AllTrackerListItem';
...
const AllTracker = ({ navigation }) => {
    ...
    const getWork = async (locid) => {
        ...
        await fetch(`${API_BASE}/app/work/listtracker`, {
            method: "POST",
            ...
            .catch((error) => {
                setLoading(false);
                console.error('WORK TRACKER There was an error!', error);
    ...
    const handleAssignTask = async () => {
        ...
        if (selectedStaff.length == 0) {
            ...
            await fetch(`${API_BASE}/app/work/assignworkbatch`, {
                ...
                .catch((error) => {
                    setLoading(false);
                    console.error('ASSIGN WORK TRACKER There was an error!', error);
                    Snackbar.show({ text: 'Error Occured. Please Try again. ' + error, duration: Snackbar.LENGTH_SHORT })
                })
        }
