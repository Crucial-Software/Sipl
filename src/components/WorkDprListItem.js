...
const WorkDprListItem = ({ item, index, navigation, staffId, functionGetWork }) => {
    ...
    return (
        <View>
            <TouchableOpacity onPress={() => { navigation.navigate("DPR Details", { workDetailsItem: item, staffId: staffId, functionGetWork: (staffId) => functionGetWork(staffId) }) }}
...
export default WorkDprListItem
